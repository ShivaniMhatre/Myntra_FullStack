    ...
    return (
        <div id='navbar'>
            <div id='inner_nav'>
                ...
                <div id='navi'>
                    <p onClick={()=>route('/men_multiple')}>MEN</p>
                    <p onClick={()=>route('/women_multiple')}>WOMEN</p>
                    <p>KIDS</p>
                    <p>HOME & LIVING</p>
                    <p>BEAUTY</p>
                ...
                <div id='nav_profile'>
                    {state?.user ? <div id='user_profile' onMouseEnter={falldown} onMouseLeave={fallup}>
                        <div><i class="fa-solid fa-user"></i></div>
                        <p><small>{state?.user?.name}<sup style={{ color: 'red' }}><small>{state?.user?.role}</small></sup></small></p>
                        <p></p>
                    </div>
                        :
                        <div id='user_profile' onMouseEnter={falldown} onMouseLeave={fallup}>
                            <div><i class="fa-solid fa-user"></i></div>
            ...
            {profiledropdown && <div id='profile_dropdown' onMouseEnter={falldown} onMouseLeave={fallup}>
                <div id='inner_dropdown'>
                    {state?.user ?
                        <div id='top_div'>
                        ...
                        <div id='top_div'>
                            ...
                            <div id='signin' onClick={()=>route('/login')}>
                                <h4>Login/SignUp</h4>
                            </div>
                        </div>}
                    <div id='middle_div'>
                        <ul>
                            ...
                            {/* <span style={{ width: '20%', backgroundColor: 'red', margin: '10px' }}>NEW</span> */}
                        </ul>
                    </div>
                    <div id='bottom_div'>
                        <ul>
                    ...
                    {state?.user &&
                        <div id='edit_div'>
                            <ul>
                                <li onClick={()=>route('/profile')}>Edit Profile</li>
